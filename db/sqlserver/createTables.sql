...
CREATE TABLE feature (datasource nvarchar(100), featureid varchar(100) NOT NULL, title nvarchar(255) NOT NULL, description nvarchar(255), searchstring nvarchar(MAX), wkt nvarchar(MAX), json nvarchar(MAX));
