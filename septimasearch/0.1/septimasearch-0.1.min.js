...
c,"does not exist in jQuery.betterAutocomplete."].join(" "))}});return this};var b=function(b,c,f,h){function k(c){if(!("object"==a.type(c)&&"keyup"==c.type&&0<=a.inArray(c.keyCode,[38,40]))){var d=h.canonicalQuery(b.val(),f.caseSensitive);clearTimeout(q);q=null;v();d.length>=f.charLimit&&(!a.isArray(p[d])&&-1==a.inArray(d,s))&&(j.empty(),m?A(d):q=setTimeout(function(){A(d);q=null},f.delay))}}var l="",p={},r=[],u=0,q,s=[],t=!1,n={},m="string"!=a.type(c),j=a("\x3cul /\x3e").addClass("better-autocomplete"),
x=!0,w=null;f=a.extend({charLimit:m?1:3,delay:350,caseSensitive:!1,cacheLimit:m?0:256,remoteTimeout:1E4,crossOrigin:!1,selectKeys:[9,13],autoHighlight:!0},f);h=a.extend({},d,h);h.insertSuggestionList(j,b);n.focus=function(){w||v(!0)};n.blur=function(){w?b.focus():v()};n.keydown=function(b){var c=z();if(0<=a.inArray(b.keyCode,[38,40])&&0<j.children().length){var d,e=a(".result",j).length;switch(b.keyCode){case 38:d=Math.max(0,c-1);break;case 40:d=Math.min(e-1,c+1)}t=!0;y(d,"key",!0);return!1}if(0<=
a.inArray(b.keyCode,f.selectKeys)&&!b.shiftKey&&!b.ctrlKey&&!b.altKey&&!b.metaKey)return B(),9==b.keyCode};n.keyup=n.click=k;j.delegate(".result",{mouseenter:function(){t||y(a(".result",j).index(a(this)),"mouse")},mousemove:function(){t=!1},mousedown:function(){B();return!1}});j.mousedown(function(){clearTimeout(w);w=setTimeout(function(){w=null},50);return!1});j.mouseleave(function(){f.autoHighlight||y(-1)});this.enable=function(){b.attr("autocomplete","OFF").attr("aria-autocomplete","list");b.bind(n)};
this.disable=function(){b.removeAttr("autocomplete").removeAttr("aria-autocomplete");j.hide();b.unbind(n)};this.destroy=function(){j.remove();b.unbind(n);b.removeData("better-autocomplete")};this.doSearch=function(a){b.focus();p={};r=[];u=0;this.setInputText(a);k(null)};this.repeatSearch=function(){b.focus();p={};r=[];u=0;k(null)};this.setInputText=function(a){var c=a.indexOf("\x3cselect\x3e");if(-1<c){var d=a.indexOf("\x3c/select\x3e");if(-1<c){var f=d-c-8;a=a.substring(0,c)+a.substring(c+8,d)+a.substring(d+
9);b.val(a);b.caret(c,c+f)}}else b.val(a)};var C=function(a,b){for(u+=b.length;u>f.cacheLimit&&r.length;){var c=r.shift();u-=p[c].length;delete p[c]}r.push(a);p[a]=b},y=function(c,d,f){var g=z(),l=a(".result",j);l.removeClass("highlight");if(!(0>c)){l.eq(c).addClass("highlight");if(g!=c){var r=D(c);h.highlight(r.data("result"),b,d)}d=0==c||c<g;c=l.eq(c);f&&(c.prev().is(".group")&&d&&(c=c.prev()),0>c.position().top?j.scrollTop(c.position().top+j.scrollTop()):c.position().top+c.outerHeight()>j.height()&&
j.scrollTop(c.position().top+j.scrollTop()+c.outerHeight()-j.height()))}},z=function(){var b=a(".result.highlight",j);return a(".result",j).index(b)},D=function(b){b=a(".result",j).eq(b);if(b.length)return b},B=function(){var a=z(),a=D(a);h.select(a.data("result"),b)},A=function(d){if(m)C(d,h.queryLocalResults(d,c,f.caseSensitive)),v();else{s.push(d);var l=h.constructURL(c,d);h.beginFetching(b);h.fetchRemoteData(l,function(c){c=h.processRemoteData(c);a.isArray(c)||(c=[]);C(d,c);s=a.grep(s,function(a){return a!=
d});s.length||h.finishFetching(b);v()},f.remoteTimeout,f.crossOrigin)}},v=function(c){var d=h.canonicalQuery(b.val(),f.caseSensitive);if(a.isArray(p[d])){if(l!==d){l=d;d=p[d];j.empty();var g={};0==d.length&&j.append("Ingen resultater");a.each(d,function(b,c){if("object"==a.type(c)){var d=h.themeResult(c);if(null!=d){if("string"==a.type(d))d=jQuery(d);else if(!(d instanceof jQuery))return;var e=h.getGroup(c);if("string"==a.type(e)&&!g[e]){var f=a("\x3cli /\x3e").addClass("group").append(a("\x3ch3 /\x3e").html(e)).appendTo(j);
g[e]=f}d=a("\x3cli /\x3e").addClass("result").append(d).data("result",c).addClass(c.addClass);"string"!=a.type(e)&&!j.children().first().is(".result")?j.prepend(d):(e="string"==a.type(e)?g[e]:j.children().first(),f=e.nextUntil(".group").last(),d.insertAfter(f.length?f:e))}}});f.autoHighlight&&0<a(".result",j).length&&y(0,"auto")}}else l=null,j.empty();(b.is(":focus")||c)&&!j.is(":empty")?(h.show(j),j.scrollTop(j.data("scroll-top"))):j.is(":visible")&&(h.hide(j),j.data("scroll-top",j.scrollTop()))};
...
left:b.position().left,top:b.position().top+b.outerHeight(),zIndex:10,maxHeight:"330px",boxShadow:"0 0 15px rgba(0, 0, 0, 0.5)"}).hide().insertAfter(b)}},c=a.expr[":"];c.focus||(c.focus=function(a){return a===document.activeElement&&(a.type||a.href)})})(jQuery);(function(a,b,d,c){a.fn.caret=function(e,g){var f,h,k=this[0],l=a.browser.msie;"object"===typeof e&&"number"===typeof e.start&&"number"===typeof e.end?(f=e.start,h=e.end):"number"===typeof e&&"number"===typeof g?(f=e,h=g):"string"===typeof e?-1<(f=k.value.indexOf(e))?h=f+e[b]:f=null:"[object RegExp]"===Object.prototype.toString.call(e)&&(e=e.exec(k.value),null!=e&&(f=e.index,h=f+e[0][b]));if("undefined"!=typeof f)return l?(l=this[0].createTextRange(),l.collapse(!0),l.moveStart("character",f),l.moveEnd("character",
h-f),l.select()):(this[0].selectionStart=f,this[0].selectionEnd=h),this[0].focus(),this;if(l)if(h=document.selection,"textarea"!=this[0].tagName.toLowerCase()){l=this.val();f=h[d]()[c]();f.moveEnd("character",l[b]);var p=""==f.text?l[b]:l.lastIndexOf(f.text);f=h[d]()[c]();f.moveStart("character",-l[b]);var r=f.text[b]}else f=h[d](),h=f[c](),h.moveToElementText(this[0]),h.setEndPoint("EndToEnd",f),p=h.text[b]-f.text[b],r=p+f.text[b];else p=k.selectionStart,r=k.selectionEnd;f=k.value.substring(p,r);
return{start:p,end:r,text:f,replace:function(a){return k.value.substring(0,p)+a+k.value.substring(r,k.value[b])}}}})(jQuery,"length","createRange","duplicate");"object"!==typeof window.JSON&&(window.JSON={});
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=h[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function d(a,c){var e,h,q,s,t=g,n,m=c[a];m&&("object"===typeof m&&"function"===typeof m.toJSON)&&(m=m.toJSON(a));"function"===typeof k&&(m=k.call(c,a,m));switch(typeof m){case "string":return b(m);case "number":return isFinite(m)?String(m):"null";case "boolean":case "null":return String(m);
case "object":if(!m)return"null";g+=f;n=[];if("[object Array]"===Object.prototype.toString.apply(m)){s=m.length;for(e=0;e<s;e+=1)n[e]=d(e,m)||"null";q=0===n.length?"[]":g?"[\n"+g+n.join(",\n"+g)+"\n"+t+"]":"["+n.join(",")+"]";g=t;return q}if(k&&"object"===typeof k){s=k.length;for(e=0;e<s;e+=1)"string"===typeof k[e]&&(h=k[e],(q=d(h,m))&&n.push(b(h)+(g?": ":":")+q))}else for(h in m)Object.prototype.hasOwnProperty.call(m,h)&&(q=d(h,m))&&n.push(b(h)+(g?": ":":")+q);q=0===n.length?"{}":g?"{\n"+g+n.join(",\n"+
...
e=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g,f,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},k;"function"!==typeof window.JSON.stringify&&(window.JSON.stringify=function(a,b,c){var e;f=g="";if("number"===typeof c)for(e=0;e<c;e+=1)f+=" ";else"string"===typeof c&&(f=c);if((k=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return d("",
...
"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return e=eval("("+a+")"),"function"===typeof b?d({"":e},""):e;throw new SyntaxError("JSON.parse");})})();var Septima={Class:function(){var a=arguments.length,b=arguments[0],d=arguments[a-1],c="function"==typeof d.initialize?d.initialize:function(){b.apply(this,arguments)};1<a?(a=[c,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),d),Septima.inherit.apply(null,a)):c.prototype=d;return c},bind:function(a,b){var d=Array.prototype.slice.apply(arguments,[2]);return function(){var c=d.concat(Array.prototype.slice.apply(arguments,[0]));return a.apply(b,c)}},extend:function(a,b){a=a||{};if(b){for(var d in b){var c=
b[d];void 0!==c&&(a[d]=c)}!("function"==typeof window.Event&&b instanceof window.Event)&&(b.hasOwnProperty&&b.hasOwnProperty("toString"))&&(a.toString=b.toString)}return a},inherit:function(a,b){var d=function(){};d.prototype=b.prototype;a.prototype=new d;var c,e,d=2;for(c=arguments.length;d<c;d++)e=arguments[d],"function"===typeof e&&(e=e.prototype),Septima.extend(a.prototype,e)}};Septima.Search={};Septima.Search.Controller=function(a,b,d){this.searcherRegs=a;this.searchers=[];for(a=0;a<this.searcherRegs.length;a++)this.searcherRegs[a].searcher.title=this.searcherRegs[a].title,this.searchers.push(this.searcherRegs[a].searcher);this.view=b;this.targettingResult=this.activeDataFetcher=null;this.onErrorHandlers=[Septima.bind(this.view.error,this.view)];null!=d&&jQuery.isFunction(d.onError)&&this.addErrorHandler(d.onError)};
...
Septima.Search.Controller.prototype.fetchDataCallback=function(a,b){a===this.activeDataFetcher&&(jQuery.isFunction(a.completeCallback)?(a.completeCallback(b.getAllResults()),this.view.setSuggestions(null,b.getSuggestions())):this.view.setResults(b.getResults()),this.activeDataFetcher=null)};Septima.Search.Controller.prototype.selectedSearcherChange=function(){this.targettingResult=null};
Septima.Search.Controller.prototype.fetchDataFromQueryObject=function(a,b){null!=this.activeDataFetcher&&(this.activeDataFetcher.cancel(),this.activeDataFetcher=null);var d=[],c=Septima.Search.Query.Builder().copy(a),e=this.getSearchersFromQuery(a),d=0<e.length?d.concat(e):d.concat(this.searchers),c=1==d.length?c.type("list.force"):c.type("list"),c=c.limit(Math.round(a.limit/d.length)).build();this.activeDataFetcher=new Septima.Search.DataFetcher(this,d);null!=b&&jQuery.isFunction(b)&&(this.activeDataFetcher.completeCallback=
...
this.searchers[d].title.toLowerCase())&&b.push(this.searchers[d])}return b};Septima.Search.Controller.prototype.getSearcherFromId=function(a){for(var b=0;b<this.searchers.length;b++)if(this.searchers[b].getId()==a)return this.searchers[b];return null};Septima.Search.Controller.prototype.fetchError=function(a,b,d){if(a===this.activeDataFetcher)for(a=0;a<this.onErrorHandlers.length;a++)this.onErrorHandlers[a](b,d)};Septima.Search.DefaultView=function(a,b){if(void 0==b||void 0==b.input)throw"New Septima.Search.DefaultView(options): Options.input is missing.";this.options=b;this.container=jQuery("#"+b.input);this.placeHolderText="S\u00f8g";void 0!=b.placeholder&&(this.placeHolderText=b.placeholder);this.limit=15;void 0!=b.limit&&(this.limit=b.limit);this.allowSelectSearcherId=!1;this.allowSuggestions=!0;this.bac;this.visibleInterests=[];this.advancedIsVisible=this.isVisible=!1;this.fixedDisplayText=this.fixedDisplayHideFunction=
this.fixedDisplay=this.header=this.searcherButtons=this.$advancedMenuIcon=this.$suggestionList=this.$suggestionContainer=this.$gui=null;this.hasFixedDisplay=!1;this.fetchDataHandler=this.onSelectHandler=this.myInputField=null};Septima.Search.DefaultView.prototype.blur=function(a){document.getElementById("mysearchbox").blur();a&&this.hideGui()};
...
Septima.Search.DefaultView.prototype.createGui=function(a,b){a.addClass("inputcontainer");this.header=jQuery('\x3cdiv class\x3d"searchheader"/\x3e');this.myInputField=jQuery('\x3cinput id\x3d"mysearchbox" class\x3d"search" placeholder\x3d"'+this.placeHolderText+'" autocomplete\x3d"off" role\x3d"textbox" aria-autocomplete\x3d"list" aria-haspopup\x3d"true"\x3e');this.header.append(jQuery('\x3cdiv class\x3d"searchbackground"\x3e\x3c/div\x3e').append(this.myInputField));var d=jQuery('\x3cdiv class\x3d"searchmenu"\x3e\x3c/div\x3e');
this.$suggestionList=jQuery('\x3cdiv class\x3d"suggestions"\x3e\x3c/div\x3e');d.append(this.$suggestionList);this.header.append(d);this.fixedDisplay=jQuery('\x3cdiv class\x3d"fixeddisplay"/\x3e');this.fixedDisplayText=jQuery("\x3cspan\x3e\x3c/span\x3e");this.fixedDisplay.append(this.fixedDisplayText);var c=jQuery('\x3cspan class\x3d"closebutton"\x3e\x3c/span\x3e');c.click(Septima.bind(this.closeFixedText,this));this.fixedDisplay.append(c);this.fixedDisplay.hide();this.resultscontainer=jQuery('\x3cdiv class\x3d"searchresult"/\x3e');
a.append(this.header);a.append(this.fixedDisplay);a.append(this.resultscontainer);if(this.allowSelectSearcherId){var e=jQuery('\x3ca title\x3d"" class\x3d"menubutton"\x3eS\u00f8g i\x3c/a\x3e');e.click(Septima.bind(function(a){a=jQuery(a).parent().find("ul");this.toggleAdvancedControls(a);return!1},this,e));c=jQuery('\x3cli class\x3d"menu"\x3e');c.append(e);e=jQuery('\x3cul class\x3d"sub"\x3e');c.append(e);for(var g=0;g<b.length;g++){var f=b[g].getId(),h=b[g].title,k=jQuery("\x3cli\x3e"),l=jQuery("\x3ca \x3e"+
h+"\x3c/a\x3e");this.searcherButtons[f]=l;l.click(Septima.bind(function(a,b){this.setSelectedSearcherId(a,b);return!1},this,h,f));k.append(l);e.append(k)}d.append(jQuery('\x3cdiv class\x3d"right"\x3e').append(jQuery('\x3cul class\x3d"buttongroup"\x3e').append(c)))}a.bind({mouseenter:Septima.bind(this.guiEventMouseEnter,this),mouseleave:Septima.bind(this.guiEventMouseLeave,this)});this.myInputField.bind({mouseenter:Septima.bind(this.inputwrapperEventMouseEnter,this),mouseleave:Septima.bind(this.inputwrapperEventMouseLeave,
this)})};Septima.Search.DefaultView.prototype.toggleAdvancedControls=function(a){this.advancedIsVisible?(a.hide(),this.advancedIsVisible=!1):(a.fadeIn("fast"),this.advancedIsVisible=!0)};Septima.Search.DefaultView.prototype.fetchRemoteData=function(a,b,d){this.$suggestionList.empty();this.fetchDataHandler(a,Septima.bind(function(a,b){a(b);0==b.length&&this.resultscontainer.children().empty()},this,b),this.limit,d)};Septima.Search.DefaultView.prototype.themeResult=function(a){return Septima.Search.ThemeResult(a)};
Septima.Search.DefaultView.prototype.select=function(a){return this.onSelectHandler(a)};Septima.Search.DefaultView.prototype.doTextSearch=function(a){this.bac.doSearch(a)};Septima.Search.DefaultView.prototype.setSuggestions=function(a,b){if(0<b.length)for(var d=0;d<b.length;d++){var c=b[d];jQuery('\x3cspan class\x3d"button"\x3e'+c.title+"\x3c/span\x3e").appendTo(this.$suggestionList).click(Septima.bind(function(a){this.doTextSearch(a)},this,c.newquery))}};
...
Septima.Search.ResultList.prototype.addResult=function(a){var b=$("\x3cli /\x3e").addClass("result"),d=Septima.Search.ThemeResult(a);b.append(d);b.data("result",a);b.addClass(a.addClass);this.resultList.prepend(b);a=$(".result",this.resultList);a.removeClass("highlight");a.removeClass("selected");b.addClass("selected");this.hasFooter&&this.clearIcon.css({display:"inline"})};Septima.Search.ThemeResult=function(a){var b=a.searcher;if(jQuery.isFunction(b.themeResult))return b.themeResult(a);var b=this.createCustomButtons(a),b=b.add("\x3ch4\x3e"+a.title+"\x3c/h4\x3e"),d=jQuery("\x3cp style\x3d'vertical-align: top;'/\x3e");a.hasOwnProperty("image")&&(null!=a.image&&""!=a.image)&&(d.append('\x3cdiv style\x3d"float: left;"\x3e\x3cimg style\x3d"height: 20px;" src\x3d"'+a.image+'"\x3e\x3c/div\x3e'),d.css("min-height","20px"));a.hasOwnProperty("description")&&null!=a.description&&
d.append("\x3cdiv style\x3d'display: inline;'\x3e"+a.description+"\x3c/div\x3e");if(a.hasOwnProperty("description")&&null!=a.description||a.hasOwnProperty("image")&&null!=a.image&&""!=a.image)b=b.add(d);return b};Septima.Search.createCustomButtons=function(a){for(var b=a.searcher.getCustomButtonDefs(a),d=jQuery(),c=0;c<b.length;c++)var e=this.createCustomButton(a,b[c]),d=d.add(e);return d};
Septima.Search.createCustomButton=function(a,b){var d=b.callBack;if(void 0==b.buttonImage){var c=jQuery('\x3cspan class\x3d"button"\x3e\x3c/span\x3e');c.append(b.buttonText)}else c=jQuery("\x3cimg class\x3d'custombutton' title\x3d'"+b.buttonText+"' style\x3d'float: right;' src \x3d '"+b.buttonImage+"'\x3cimg\x3e");c.mousedown(Septima.bind(function(a,b,c){a=a(b);null!=a&&(void 0==a.buttonImage?(c.empty(),c.append(a.buttonText)):(c.attr("src",a.buttonImage),c.attr("title",a.buttonText)));return!1},
this,d,a,c));return c};Septima.Search.Searcher=Septima.Class({_id:null,_onSelectCallback:null,attributesPropertyName:"attributes",customButtonDefs:null,onNewQueryHandlers:null,Searcher:function(a){this.customButtonDefs=[];this.onNewQueryHandlers=[];void 0!=a&&jQuery.isFunction(a.onSelect)&&(this._onSelectCallback=a.onSelect);this._id=this.CLASS_NAME+"_"+Math.floor(999999999*Math.random())},getId:function(){return this._id},createQueryResult:function(){return new Septima.Search.QueryResult(this)},fetchData:function(a,b){b.fetchError(this,
...
c.statusText))},getDataFromSmartResult:function(a){for(var b=this.createQueryResult(),d=0;d<a.numHits;d++){var c=a.data[d];"streetNameType"==c.type?b.addNewQuery(c.presentationString,null,c.streetName+" \x3cselect\x3e1\x3c/select\x3e, "+c.postCodeIdentifier+" "+c.districtName,c.geometryWkt,c,c.streetName):b.addResult(c.presentationString,null,c.geometryWkt,c)}return b},error:function(a,b,d,c){a.fetchError(this,c)},CLASS_NAME:"Septima.Search.AddressSearcher"});Septima.Search.PlanSearcher=Septima.Class(Septima.Search.Searcher,{searchindexServiceUrl:"http://searchindex.septima.dk/",index:"lokalplaner_vedtaget",pdfUri:null,fields:"plannavn plannr anvendelsegenerel planid wkt doklink geom_simplify_10".split(" "),filter:null,prettyOutput:!1,targets:{},initialize:function(a){this.Searcher(a);this.pdfUri="data:image/gif;base64,R0lGODlhEAAQALMPAPsICf+0tP+KiqcBAtygof/q6vxhYf/Y2IsBA+5UVfYSFcbGxoSEhAAAAP///////yH5BAEAAA8ALAAAAAAQABAAAARm8ElGq5X4Mcc7Z41EJCSpJIrygY+ZvgDCNXSDvikADN7SKIigcEDshSaeRMCI2XAKBkGh42t2BIGDIXuoIjlbgcCgMBiOGk5gO3UUAgT0Zn3wcLwag9J+l5vbdngMC4SFhoI1iYoRADs\x3d";
this.addCustomButtonDef({buttonText:"Se plandokument",buttonImage:this.pdfUri,callBack:Septima.bind(this.openPlanDok,this)})},getCustomButtonDefs:function(a){return a.newquery?[]:this.customButtonDefs},openPlanDok:function(a){window.open(a.data["properties.doklink"],"_blank")},hasTarget:function(a){return this.targets.hasOwnProperty(a)},createQueryString:function(a){for(var b=jQuery.trim(a.queryString);null!=b.match(/  /);)b=b.replace(/  /g," ");b=b.replace(/[^a-z\u00e6\u00f8\u00e50-9\ ]/gi,"");b=
b.split(" ");b=b.join("* ")+"*";a={fields:this.fields,size:a.limit,query:{query_string:{fields:["plannavn^2.0","text^1.0","planid^3.0"],default_operator:"AND",query:b,lenient:!0}}};this.filter&&(a.filter={query:{term:this.filter}});return window.JSON.stringify(a)},fetchData:function(a,b){null==a.geometry&&(this.request=jQuery.ajax({url:this.searchindexServiceUrl+this.index+"/_search?pretty\x3d"+this.prettyOutput,type:"GET",data:{source:this.createQueryString(a)},jsonp:"callback",dataType:"jsonp",
cache:!1,timeout:a.timeout,crossDomain:!0,success:Septima.bind(function(a,b,e,g,f){e.query=b;this.success(a,e,g,f)},this,b,a),error:Septima.bind(function(a,b,e,g){this.error(a,b,e,g)},this,b)}))},success:function(a,b,d,c){200==c.status?a.fetchSuccess(this.parseResult(b)):a.fetchError(this,c.statusText)},error:function(a,b,d,c){a.fetchError(this,c)},parseResult:function(a){var b=this.createQueryResult(),d=a.query,c=a.hits.total;if(!d.hasTarget)for(var e in this.targets)0==e.indexOf(d.queryString.toLowerCase())&&
b.addSuggestion(this.targets[e].title,e+":");if(c<=d.limit||"list.force"==d.type)for(d=0;d<a.hits.hits.length;d++)c=a.hits.hits[d].fields,a.hits.hits[d].highlight&&(c._highlight=a.hits.hits[d].highlight),b.addResult(c["properties.plannavn"],"Plannummer "+c["properties.plannr"]+" - "+c["properties.anvendelsegenerel"],c["properties.wkt"],c);else b.addNewQuery("Planer ("+c+")","Der er fundet "+c+" planer, der matcher \x3cem\x3e"+d.queryString+"\x3c/em\x3e",d.queryString,null,null,null);return b},onSelect:function(a){a.newquery||
this._onSelectCallback(a)},CLASS_NAME:"Septima.Search.PlanSearcher"});Septima.Search.PlanWfsSearcher=Septima.Class(Septima.Search.Searcher,{pdfUri:null,initialize:function(a){this.Searcher(a);this.pdfUri="data:image/gif;base64,R0lGODlhEAAQALMPAPsICf+0tP+KiqcBAtygof/q6vxhYf/Y2IsBA+5UVfYSFcbGxoSEhAAAAP///////yH5BAEAAA8ALAAAAAAQABAAAARm8ElGq5X4Mcc7Z41EJCSpJIrygY+ZvgDCNXSDvikADN7SKIigcEDshSaeRMCI2XAKBkGh42t2BIGDIXuoIjlbgcCgMBiOGk5gO3UUAgT0Zn3wcLwag9J+l5vbdngMC4SFhoI1iYoRADs\x3d";this.addCustomButtonDef({buttonText:"Se plandokument",buttonImage:this.pdfUri,callBack:Septima.bind(this.openPlanDok,
...
fetchData:function(a,b){var d={resources:this.resources.join(","),search:encodeURIComponent(a.queryString),limit:a.limit},d=Septima.extend(d,this.params);jQuery.ajax({url:this.serviceUrl,data:d,dataType:"jsonp",cache:!1,timeout:1E4,crossDomain:!0,success:Septima.bind(function(a,b,d,f){this.success(a,b,d,f)},this,b),error:Septima.bind(function(a,b,d,f){this.error(a,f)},this,b)})},success:function(a,b,d,c){200==c.status?a.fetchSuccess(this.parseResult(b)):a.fetchError(this,c.statusText)},error:function(a,
...
"streetNameType"==c.type?b.addNewQuery(c.presentationString,null,c.streetName+" \x3cselect\x3e1\x3c/select\x3e, "+c.postCodeIdentifier+" "+c.districtName,c.geometryWkt,c,c.streetName):b.addResult(c.presentationString,null,c.geometryWkt,c)}return b},CLASS_NAME:"Septima.Search.GeoSearch"});Septima.Search.CVR_enhedSearcher=Septima.Class(Septima.Search.Searcher,{serviceUrl:"http://searchindex.septima.dk/",index:"cvr_enheder",fields:"navn wkt adresse_officiel postdist_officiel postnr_officiel cvrnr".split(" "),filter:null,targets:{},initialize:function(a){this.Searcher(a);this.addCustomButtonDef({buttonText:"Se mere",callBack:Septima.bind(this.openCvrLink,this)})},getCustomButtonDefs:function(a){return a.newquery?[]:this.customButtonDefs},openCvrLink:function(a){window.open("http://cvr.dk/Site/Forms/PublicService/DisplayCompany.aspx?cvrnr\x3d"+
a.data["properties.cvrnr"],"_blank")},hasTarget:function(a){return this.targets.hasOwnProperty(a)},createQueryString:function(a){for(var b=jQuery.trim(a.queryString);null!=b.match(/  /);)b=b.replace(/  /g," ");b=b.replace(/[^a-z\u00e6\u00f8\u00e50-9\ ]/gi,"");b=b.split(" ");b=b.join("* ")+"*";a={fields:this.fields,size:a.limit,query:{query_string:{default_field:"_all",default_operator:"AND",query:b,lenient:!0}}};this.filter&&(a.filter={query:{term:this.filter}});return window.JSON.stringify(a)},fetchData:function(a,
b){this.request=jQuery.ajax({url:this.serviceUrl+this.index+"/_search?pretty\x3dtrue",type:"GET",data:{source:this.createQueryString(a)},jsonp:"callback",dataType:"jsonp",cache:!1,timeout:a.timeout,crossDomain:!0,success:Septima.bind(function(a,b,e,g,f){e.query=b;this.success(a,e,g,f)},this,b,a),error:Septima.bind(function(a,b,e,g){this.error(a,b,e,g)},this,b)})},success:function(a,b,d,c){a.isActive()&&(200==c.status?a.fetchSuccess(this.parseResult(b)):a.fetchError(this,c.statusText))},error:function(a,
b,d,c){a.fetchError(this,c)},parseResult:function(a){var b=this.createQueryResult(),d=a.query,c=a.hits.total;if(!d.hasTarget)for(var e in this.targets)0==e.indexOf(d.queryString.toLowerCase())&&b.addSuggestion(this.targets[e].title,e+":");if(c<=d.limit||"list.force"==d.type)for(d=0;d<a.hits.hits.length;d++)c=a.hits.hits[d].fields,a.hits.hits[d].highlight&&(c._highlight=a.hits.hits[d].highlight),b.addResult(c["properties.navn"],c["properties.navn"]+", "+c["properties.postnr_officiel"]+" "+c["properties.postdist_officiel"],
c["properties.wkt"],c);else b.addNewQuery("Virksomheder ("+c+")","Der er fundet "+c+" virksomheder, der matcher \x3cem\x3e"+d.queryString+"\x3c/em\x3e",d.queryString,null,null,null);return b},onSelect:function(a){a.newquery||this._onSelectCallback(a)},CLASS_NAME:"Septima.Search.CVR_enhedSearcher"});