...
this.$suggestionContainer=this.$gui=null;this.hasFixedDisplay=!1;this.fetchDataHandler=this.onSelectHandler=this.myInputField=null};Septima.Search.DefaultView.prototype.blur=function(a){document.getElementById("mysearchbox").blur();a&&this.hideGui()};
...
Septima.Search.DefaultView.prototype.createGui=function(a){a.addClass("inputcontainer");this.header=jQuery('\x3cdiv class\x3d"searchheader"/\x3e');this.myInputField=jQuery('\x3cinput id\x3d"mysearchbox" class\x3d"search" placeholder\x3d"'+this.placeHolderText+'" autocomplete\x3d"off" role\x3d"textbox" aria-autocomplete\x3d"list" aria-haspopup\x3d"true"\x3e');this.header.append(jQuery('\x3cdiv class\x3d"searchbackground"\x3e\x3c/div\x3e').append(this.myInputField));var b=jQuery('\x3cdiv class\x3d"searchmenu"\x3e\x3c/div\x3e');
this.$suggestionList=jQuery('\x3cdiv class\x3d"suggestions"\x3e\x3c/div\x3e');b.append(this.$suggestionList);this.header.append(b);this.fixedDisplay=jQuery('\x3cdiv class\x3d"fixeddisplay"/\x3e');this.fixedDisplayText=jQuery("\x3cspan\x3e\x3c/span\x3e");this.fixedDisplay.append(this.fixedDisplayText);b=jQuery('\x3cspan class\x3d"closebutton"\x3e\x3c/span\x3e');b.click(Septima.bind(this.closeFixedText,this));this.fixedDisplay.append(b);this.fixedDisplay.hide();this.resultscontainer=jQuery('\x3cdiv class\x3d"searchresult"/\x3e');
a.append(this.header);a.append(this.fixedDisplay);a.append(this.resultscontainer);a.bind({mouseenter:Septima.bind(this.guiEventMouseEnter,this),mouseleave:Septima.bind(this.guiEventMouseLeave,this)});this.myInputField.bind({mouseenter:Septima.bind(this.inputwrapperEventMouseEnter,this),mouseleave:Septima.bind(this.inputwrapperEventMouseLeave,this)})};
Septima.Search.DefaultView.prototype.fetchRemoteData=function(a,b,d){this.$suggestionList.empty();this.fetchDataHandler(a,Septima.bind(function(a,b){a(b);0==b.length&&this.resultscontainer.children().empty()},this,b),this.limit,d)};Septima.Search.DefaultView.prototype.themeResult=function(a){return Septima.Search.ThemeResult(a)};Septima.Search.DefaultView.prototype.select=function(a){return this.onSelectHandler(a)};Septima.Search.DefaultView.prototype.doTextSearch=function(a){this.bac.doSearch(a)};
Septima.Search.DefaultView.prototype.setSuggestions=function(a,b){if(0<b.length)for(var d=0;d<b.length;d++){var c=b[d];jQuery('\x3cspan class\x3d"button"\x3e'+c.title+"\x3c/span\x3e").appendTo(this.$suggestionList).click(Septima.bind(function(a){this.doTextSearch(a)},this,c.newquery))}};Septima.Search.DefaultView.prototype.setResults=function(a){this.bac.renderResults(a)};Septima.Search.DefaultView.prototype.error=function(){};
...
b.addSuggestion(this.targets[e].title,e+":");if(c<=d.limit||"list.force"==d.type)for(d=0;d<a.hits.hits.length;d++)c=a.hits.hits[d].fields,a.hits.hits[d].highlight&&(c._highlight=a.hits.hits[d].highlight),b.addResult(c["properties.navn"],c["properties.navn"]+", "+c["properties.postnr_officiel"]+" "+c["properties.postdist_officiel"],c["properties.wkt"],c);else b.addNewQuery("Virksomheder ("+c+")","Der er fundet "+c+" virksomheder, der matcher \x3cem\x3e"+d.queryString+"\x3c/em\x3e",d.queryString,null,
null,null).image=this.cvrFolderIconUri;return b},onSelect:function(a){a.newquery||this._onSelectCallback(a)},CLASS_NAME:"Septima.Search.CVR_enhedSearcher"});