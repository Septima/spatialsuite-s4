...
Dette er et tool som understøtter s4 i søgning af veje uden husnumre (Understøttes ikke af gst), samt visning af vejgeometri når en vej er valgt i geosearch https://github.com/Septima/spatialsuite-s4/issues/45  
Inkludér i profil:  
```xml
